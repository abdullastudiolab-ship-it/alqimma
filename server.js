...
const DEFAULT_QUESTIONS = [
  {
    ...
    choices: ['المريخ', 'المشتري', 'زحل', 'نبتون'],
    correctIndex: 1
  },
  {
  ...
  },
  {
    ...
    choices: ['الدوحة', 'الريان', 'الوكرة', 'الخور'],
    correctIndex: 0
  },
  {
    text: 'متى تأسست جامعة قطر؟',
    choices: ['1973', '1977', '1981', '1985'],
    correctIndex: 1
  },
  {
    text: 'ما هو العنصر الكيميائي الذي رمزه O؟',
    choices: ['الذهب', 'الأكسجين', 'الحديد', 'الفضة'],
    correctIndex: 1
  },
  {
    text: 'كم عدد القارات في العالم؟',
    choices: ['خمس', 'ست', 'سبع', 'ثمان'],
    correctIndex: 2
  },
  {
    text: 'ما هي اللغة الأكثر انتشاراً في العالم؟',
    choices: ['العربية', 'الإنجليزية', 'الصينية', 'الإسبانية'],
    correctIndex: 2
  },
  {
    text: 'ما هو الحيوان الأسرع على وجه الأرض؟',
    choices: ['الأسد', 'الفهد', 'الحصان', 'النعامة'],
    correctIndex: 1
  },
  {
    text: 'في أي سنة استضافت قطر كأس العالم؟',
    choices: ['2018', '2020', '2022', '2024'],
    correctIndex: 2
  },
  {
    text: 'ما هو أطول نهر في العالم؟',
    choices: ['الأمازون', 'النيل', 'المسيسيبي', 'اليانغتسي'],
    correctIndex: 1
  },
  {
    text: 'كم عدد ألوان قوس القزح؟',
    choices: ['خمسة', 'ستة', 'سبعة', 'ثمانية'],
    correctIndex: 2
  },
  {
    text: 'ما هو أصغر محيط في العالم؟',
    choices: ['الهندي', 'الهادئ', 'الأطلسي', 'المتجمد الشمالي'],
    correctIndex: 3
  },
  {
    text: 'من هو مؤلف مقدمة ابن خلدون؟',
    choices: ['ابن سينا', 'ابن خلدون', 'ابن رشد', 'الفارابي'],
    correctIndex: 1
  },
  {
    text: 'ما هي أكبر دولة عربية من حيث المساحة؟',
    choices: ['السعودية', 'الجزائر', 'مصر', 'ليبيا'],
    correctIndex: 1
  },
  {
    text: 'ما هو الغاز الأكثر وجوداً في الغلاف الجوي؟',
  ...
  {
    text: 'ما هي الدولة التي تُعرف بأرض الشمس المشرقة؟',
    choices: ['الصين', 'كوريا', 'اليابان', 'تايلاند'],
    correctIndex: 2
  },
  {
    text: 'ما هو العضو الأكبر في جسم الإنسان؟',
    choices: ['القلب', 'الكبد', 'الجلد', 'الرئة'],
    correctIndex: 2
  },
  {
    text: 'من هو أول رائد فضاء عربي؟',
    choices: ['سلطان النيادي', 'هزاع المنصوري', 'الأمير سلطان بن سلمان', 'محمد فارس'],
    correctIndex: 2
  },
  {
